...
const ExtraExpTable = ({loadData, formData, setFormData, setReqType}) => {  
  ...
  return (
    <div>
        ...
        <div className='relative overflow-x-auto'>
            <Table setReqType={setReqType} columns={columns} formData={formData} setFormData={setFormData} data={loadData} /> 
        </div>
    </div>
  )
}
